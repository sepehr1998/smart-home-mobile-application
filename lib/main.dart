...
Future<String> auth() async {
  ...
  var response = await http.post(url, body: jsonEncode({'username': 'user', 'password': 'user'})
  ,headers: { "content-type": "application/json"});
  return jsonDecode(response.body)['id_token'];
}
bool trigger(int id, int value1) {
  var url = Uri.parse('http://192.168.1.19:8080/api/data');
  auth().then((value) => http.post(url,body:jsonEncode({'dataTemplateId': id, 'value': value1})
...
Future<double> getTemp() async {
  var url = Uri.parse('http://192.168.1.19:8080/api/data/4f04325e-ab00-4063-bfbd-5cf2e6e6924a/CELSIUS');
...
class _dashboardState extends State<dashboard> {
  ...
  String livingtemp ;
  Widget build(BuildContext context) {
    getTemp().then((value) => livingtemp = value.round().toString());
    return Scaffold(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                                    ...
                                    children: [
                                      Container(
                                        decoration: BoxDecoration(
                                            ...
                                            border: Border.all(width: 10, color: Color(0xff434549)),
                            ...
                            Container(
                                margin: EdgeInsets.only(right: 80, top: 15, bottom: 15),
                                child: Text(
                                    "Unlock",
                                    style: TextStyle (
                                      fontSize: 15,
                            ...
                            Container(
                                margin: EdgeInsets.only(right: 40, top:5, bottom: 10),
                                child: Text(
                                  "Locked",
                                  style: TextStyle(
                                      fontSize: 20,
                           ...
                           margin: EdgeInsets.only(top:30),
                             ...
                             child: TabBar(
                               ...
                               indicator: UnderlineTabIndicator(
                                 borderSide:
                                 BorderSide(color: Color(0xffc8a871), width: 2.0),
                               ),
                               tabs: [
                                 Tab(text: "AC Unit",),
                                 Tab(text: "Lights",),
                                   ...
                                   Container(
                                       ...
                                       child: Row(
                                         children: [
                                           ...
                                           Container(
                                               child: Text("10 Amperes", style: TextStyle(
                                                 color: Color(0xffffffff),
                                                 fontSize: 16,
                                               ),)
                                           )
                                   ...
                                   Container(
                                       ...
                                       child: Row(
                                         children: [
                                           ...
                                           Container(
                                               child: Text("60% of Room Consumption", style: TextStyle(
                                                 color: Color(0xffffffff),
                                                 fontSize: 16,
                                               ),)
                                           )
                             ...
                             Column(
                               ...
                               children: [
                                 ...
                                 Container(
                                     ...
                                     width: 300,
                                     child:
                                     Image.asset("assets/lbulbhalf.png")
                                 ),
                                 Container(
                                     margin: EdgeInsets.only(left:50),
                                     child: Row(
                                       children: [
                                         ...
                                         Container(
                                             child: Text("5 Amperes", style: TextStyle(
                                               color: Color(0xfffffffff),
                                               fontSize: 16,
                                             ),)
                                         )
                                 ...
                                 Container(
                                     ...
                                     child: Row(
                                       children: [
                                         ...
                                         Container(
                                             child: Text("40% of Room Consumption", style: TextStyle(
                                               color: Color(0xffffffff),
                                               fontSize: 16,
                                             ),)
                                         )
            ...
            children: [
              Container(
                color: Color(0xff282a2e),
                  child: TabBar(
                    indicatorColor: Color(0xffc8a871),
                    indicator: CircleTabIndicator(color: Color(0xffc8a871), radius: 4),
                    tabs: [
                      Tab(text: "AC Unit",),
                      Tab(text: "Lights",),
                    ],
                  ...
                  Container(
                    margin: EdgeInsets.only(top: 10),
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(color: Color(0xffc8a871), width: 2),
                                              ...
                                              Row(
                                                children: [
                                                  Container(
                                                      ...
                                                      margin: EdgeInsets.only(top: 10),
                                                      child:
                                                      Image.asset("assets/fanmin.png")
                                                  ),
                                                  Container(
                                                    width: 50,
                                                    height: 50,
                                                    margin: EdgeInsets.only(left: 80, top: 10),
                                                    child: Image.asset("assets/fanmed.png"),
                                                  ),
                                                  Container(
                                                    width: 50,
                                                    height: 50,
                                                    margin: EdgeInsets.only(left: 70,top: 10),
                                                    child: Image.asset("assets/fanhigh.png"),
                                          ...
                                          children: [
                                            GestureDetector(
                                              ...
                                              child: Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                      color: heat ? Color(0xff69686d): Colors.transparent,
                                                      ...
                                                      children: [
                                                              ...
                                                              width: 40,
                                                              height: 40,
                                                                child: Image.asset("assets/heatselect.png"),
                                                              ),
                                                              Container(
                                                              margin: EdgeInsets.only(left: 10),
                                                                child: Text(
                                                                  heat ? "Heat": "", style: TextStyle(
                                                                color: Color(0xffc8a871),
                                                              ),),
                                                              )
                                                              ],
                                            ...
                                            GestureDetector(
                                              ...
                                              child:  Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    color:
                                                    snow ? Color(0xff69686d): Colors.transparent,
                                                    borderRadius: BorderRadius.circular(40)
                                                ),
                                                child: Row(
                                                  children: [
                                                    Container(
                                                      width: 40,
                                                      height: 40,
                                                      child: Image.asset("assets/snowselect.png"),
                                                    ),
                                                    Container(
                                                      margin: EdgeInsets.only(left: 10),
                                                      child: Text(
                                                        snow ? "Cool": "", style: TextStyle(
                                                        color: Color(0xffc8a871),
                                                      ),),
                                                    )
                                                  ],
                                            ...
                                            GestureDetector(
                                              ...
                                              child:  Container(
                                                ...
                                                padding: EdgeInsets.all(10),
                                                decoration: BoxDecoration(
                                                    color: humid ? Color(0xff69686d): Colors.transparent,
                                                    borderRadius: BorderRadius.circular(40)
                                                ),
                                                child: Row(
                                                  children: [
                                                    Container(
                                                      width: 40,
                                                      height: 40,
                                                      child: Image.asset("assets/humidselect.png"),
                                                    ),
                                                    Container(
                                                      margin: EdgeInsets.only(left: 10),
                                                      child: Text(
                                                        humid ? "Humid": "", style: TextStyle(
                                                        color: Color(0xffc8a871),
                                                      ),),
                                                    )
                                                  ],
                                            ...
                                            GestureDetector(
                                              ...
                                              child:  Container(
                                                ...
                                                padding: EdgeInsets.all(10),
                                                decoration: BoxDecoration(
                                                    color: wind ? Color(0xff69686d): Colors.transparent,
                                                    borderRadius: BorderRadius.circular(40)
                                                ),
                                                child: Row(
                                                  children: [
                                                    Container(
                                                      width: 40,
                                                      height: 40,
                                                      child: Image.asset("assets/windselect.png"),
                                                    ),
                                                    Container(
                                                      margin: EdgeInsets.only(left: 10),
                                                      child: Text(
                                                        wind ? "Fan": "", style: TextStyle(
                                                        color: Color(0xffc8a871),
                                                      ),),
                                                    )
                                                  ],
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  margin: EdgeInsets.only(left: 15),
                                                    child: Text("lamp 1", style: TextStyle(
                                                ...
                                                Container(
                                                    ...
                                                    child: Text(
                                                      lamp1 ? "ON":"OFF", style: TextStyle(
                                                      color: lamp1? Color(0xffc8a871):Color(0xff7b7b7f),
                                                      fontSize: 24,
                                                      fontWeight: FontWeight.bold,
                                                    ),)
                                                )
                                        ...
                                        Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                    margin: EdgeInsets.only(left: 15),
                                                    child: Text("lamp 3", style: TextStyle(
                                                      color: Color(0xff7b7b7f),
                                                      fontSize: 22,
                                                    ),)
                                                ),
                                                Container(
                                                    ...
                                                    child: Text(
                                                      lamp3 ? "ON": "OFF",
                                                      style: TextStyle(
                                                      color: lamp3? Color(0xffc8a871):Color(0xff7b7b7f) ,
                                                      fontSize: 24,
                                                      fontWeight: FontWeight.bold,
                                                    ),)
                                                )
                                      ...
                                      Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                  margin: EdgeInsets.only(left: 15),
                                                  child: Text("lamp 2", style: TextStyle(
                                                    color: Color(0xff7b7b7f),
                                                    fontSize: 22,
                                                  ),)
                                              ),
                                              Container(
                                                  margin: EdgeInsets.only(left: 15,top: 5),
                                                  child: Text(
                                                    lamp2?"ON":"OFF", style: TextStyle(
                                                    color: lamp2? Color(0xffc8a871):Color(0xff7b7b7f),
                                                    fontSize: 24,
                                                    fontWeight: FontWeight.bold,
                                                  ),)
                                              )
                                      ...
                                      Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                  margin: EdgeInsets.only(left: 15),
                                                  child: Text("lamp 4", style: TextStyle(
                                                    color: Color(0xff7b7b7f),
                                                    fontSize: 22,
                                                  ),)
                                              ),
                                              Container(
                                                  margin: EdgeInsets.only(left: 15,top: 5),
                                                  child: Text(
                                                    lamp4?"ON":"OFF", style: TextStyle(
                                                    color: lamp4? Color(0xffc8a871):Color(0xff7b7b7f),
                                                    fontSize: 24,
                                                    fontWeight: FontWeight.bold,
                                                  ),)
                                              )
